...
col3.plotly_chart(make_gauge(distance_this_month(filtered_activities),200,f"Distance {datetime.today().strftime('%B')}",'km'),use_container_width=True)
col4.plotly_chart(make_gauge(distance_last_week(filtered_activities),50,f"Distance last 7 Days",'km'),use_container_width=True)
